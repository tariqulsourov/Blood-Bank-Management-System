...
<div class="row">
    <div class="col-md-2">
        <div class="sidebar content-box" style="display: block;">
            <ul class="nav">
                <!-- Main menu -->
                <li class="current"><a href="{{route('frontend.dash.admindash')}}"><i class="glyphicon glyphicon-home"></i> Dashboard</a></li>
                <li><a href="{{route('frontend.dash.bloodreceiverform')}}"><i class="glyphicon glyphicon-user"></i> Blood Receiver Form</a></li>
                <li><a href="{{route('frontend.dash.sendsmsform')}}"><i class="glyphicon glyphicon-tasks"></i> Send SMS Request</a></li><br>
                <li><a href="{{route('frontend.dash.collectbloodform')}}"><i class="glyphicon glyphicon-usd"></i> Check Donor</a></li>
                <li><a href="{{route('frontend.dash.bloodbagform')}}"><i class="glyphicon glyphicon-usd"></i> Blood Bag Info</a></li>
