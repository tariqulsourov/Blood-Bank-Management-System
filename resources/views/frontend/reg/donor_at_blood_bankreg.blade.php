...
@section('body')
    <h1 align="center">Register as a Blood donor to donate at blood bank</h1>
    <div class="container">
                                ...
                                @else
                                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="NID" type="text" class="form-control @error('NID') is-invalid @enderror" name="NID" required autocomplete="NID" autofocus>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="blood_type" type="text" class="form-control @error('blood_type') is-invalid @enderror" name="blood_type" value="{{ old('blood_type') }}" required autocomplete="blood_type" autofocus>
                                        ...
                                        <div class="form-group row">
                                            <label for="police_station" class="col-md-4 col-form-label text-md-right">{{ __('Police Station') }}</label>

                                            <div class="col-md-6">
                                                <input id="police_station" type="text" class="form-control @error('police_station') is-invalid @enderror" name="police_station" value="{{ old('police_station') }}" required autocomplete="police_station" autofocus>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="post_office" type="text" class="form-control @error('post_office') is-invalid @enderror" name="post_office" value="{{ old('post_office') }}" required autocomplete="post_office" autofocus>
